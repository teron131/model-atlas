...
import type { ModelAtlasSourceHealth, SourceSnapshots } from "../../sources/types";
...
export function insertSourceHealth(db: DatabaseWriter, sourceHealth: ModelAtlasSourceHealth): void {
  const statement = db.prepare(`
