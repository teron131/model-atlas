...
import type { TerminalBenchAccuracyByModelName } from "../sources/terminal-bench-scraper";
...
type ModelStatsSelectedModelBase = {
	id: string | null;
	name: string | null;
...
export type ModelStatsProjectedModel = ModelStatsSelectedModelBase & {
	scoring_sources?: ModelStatsScoringSources;
	scores: ModelStatsNullableScores | null;
	relative_scores: null;
};

export type ModelStatsScoredModel = ModelStatsSelectedModelBase & {
	scoring_sources?: ModelStatsScoringSources;
	scores: ModelStatsNullableScores | null;
	relative_scores: ModelStatsNullableRelativeScores;
};

export type ModelStatsSelectedModel = ModelStatsSelectedModelBase & {
