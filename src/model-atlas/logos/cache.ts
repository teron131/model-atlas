...
async function saveCachedLogoBuffer(cachePath: string, imageBuffer: Buffer): Promise<void> {
...
async function buildCachedLogoDataUrl(source: string, cacheKey?: string | null): Promise<string> {
