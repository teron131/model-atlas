...
import type { RawSourceCacheStatus, SourceRefreshOptions, SourceRowState } from "../types";
...
export function snapshotFetchedAt(
  ...
  return hasUsableFetchedRows || cachedFetchedAt == null ? fetchedAtEpochSeconds : cachedFetchedAt;
}
