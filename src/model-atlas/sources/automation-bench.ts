...
/** Cached AutomationBench rows must retain the strict completion metric used by the parser. */
export function automationBenchCacheMatches(rows: readonly BenchmarkObservationRow[]): boolean {
