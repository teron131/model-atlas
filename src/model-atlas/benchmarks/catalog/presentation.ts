...
export const BENCHMARK_TASK_METRIC_COLUMNS = {
  ...
  arc_agi_3: [
    {
      key: "arcAgi3Cost",
      metric: "cost",
      metricSource: "arc_agi_3__source_a",
      direction: "ascending",
      label: "AGI-3$",
      tooltip: {
        title: "ARC-AGI-3 cost ↓",
        body: `Total cost divided across ${BENCHMARK_RESOURCE_PROFILES.arc_agi_3.taskRunCount} semi-private environments.`,
        details: [
          ["Source", "ARC Prize"],
  ...
  terminal_bench_4: [
    {
      key: "terminalBench4OfficialCost",
      metric: "cost",
      metricSource: "terminal_bench_4__source_a",
      direction: "ascending",
      label: "TB4$ Off",
      tooltip: {
        title: "Terminal-Bench 4.0 cost ↓",
    ...
    {
      key: "terminalBench4ArtificialAnalysisCost",
      metric: "cost",
      metricSource: "terminal_bench_4__source_b",
      direction: "ascending",
      label: "TB4$ AA",
      tooltip: {
        title: "Terminal-Bench 4.0 cost ↓",
    ...
    {
      key: "terminalBench4OfficialTokens",
      metric: "tokens",
      metricSource: "terminal_bench_4__source_a",
      direction: "ascending",
      label: "TB4 Tok Off",
      tooltip: {
        title: "Terminal-Bench 4.0 tokens ↓",
    ...
    {
      key: "terminalBench4ArtificialAnalysisTokens",
      metric: "tokens",
      metricSource: "terminal_bench_4__source_b",
      direction: "ascending",
      label: "TB4 Tok AA",
  ...
  terminal_bench_science: [
    {
      key: "terminalBenchScienceOfficialCost",
      metric: "cost",
    ...
    {
      key: "terminalBenchScienceValsCost",
      metric: "cost",
      metricSource: "terminal_bench_science__source_b",
      direction: "ascending",
      label: "TBS$ Vals",
      tooltip: {
        title: "Terminal-Bench-Science cost ↓",
