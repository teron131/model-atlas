...
import type { HistoricalDataset, HistoricalModel, HistoricalObservation } from "./schemas";

/** Construct a source identity from its base name, effort, and date before publisher reconciliation. */
