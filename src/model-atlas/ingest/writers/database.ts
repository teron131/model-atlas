...
export function firstString(row: JsonObject, keys: readonly string[]): string | null {
...
export function firstNumber(row: JsonObject, keys: readonly string[]): number | null {
  for (const key of keys) {
