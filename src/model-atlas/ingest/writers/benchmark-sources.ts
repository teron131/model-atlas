...
export type BenchmarkRawWriter = {
	table: SnapshotTableName;
	write: (db: DatabaseWriter, snapshots: SourceSnapshots) => void;
};

/** Sparse benchmarks register their special-schema serializers without sharing their implementations. */
const SPARSE_BENCHMARK_RAW_WRITERS = {
	agent_arena: {
...
const SURGE_BENCHMARK_RAW_WRITERS = {
	gdp_pdf: {
	...
	BenchmarkRuntimeKeyFor<"surge">,
	BenchmarkRawWriter
>;

const VALS_BENCHMARK_RAW_WRITERS = {
	vals_harvey_lab: {
...
} as const satisfies Record<BenchmarkRuntimeKeyFor<"vals">, BenchmarkRawWriter>;

const BENCHMARK_SOURCE_RAW_WRITERS = {
	...SURGE_BENCHMARK_RAW_WRITERS,
	...VALS_BENCHMARK_RAW_WRITERS,
	...SPARSE_BENCHMARK_RAW_WRITERS,
} as const;
