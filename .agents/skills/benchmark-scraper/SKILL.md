...
- Methodology and matching docs: benchmark inclusion standards, scoring intent, and model identity policy.
...
- Inspect real sources, not just marketing pages: leaderboard data source, paper, repo, task samples, verifier/rubric, result tables, and provenance notes.
...
- Inspect the leaderboard page, API calls, hydrated chunks, PDFs, or datasets to find the real data source.
