...
import { isMethodologyAsset, METHODOLOGY_ASSET_NAMES } from "../../methodology/documents";
...
export async function GET(_request: Request, { params }: { params: Promise<{ asset: string }> }) {
  ...
  const source = await readFile(join(process.cwd(), "docs", "assets", "methodology", asset));
