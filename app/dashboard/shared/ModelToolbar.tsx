...
function ProviderDropdown({
  ...
  const selectedOptions = options.filter((option) => selectedProviders.includes(option.slug));
  const summary =
  ...
  const toggleProvider = (provider: string) => {
    onSelectedProvidersChange(toggleProviderFilter(selectedProviders, provider));
  };
