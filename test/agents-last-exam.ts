...
} from "../src/model-atlas/benchmarks/scrapers/agents-last-exam";
...
const matchedScore = findAgentsLastExamModelScore(["missing", "gpt-5-5"], rowsByModelName);
...
assertDeepEqual(
  buildTaskMetrics(null, {
    agents_last_exam: {
      ...gptScore,
      mean_duration_seconds_per_task: gptScore.median_duration_seconds_per_task + 1,
