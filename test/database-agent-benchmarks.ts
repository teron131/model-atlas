...
const snapshots = {
  ...
  vendingBench2DataUrl: "https://andonlabs.com/_app/immutable/chunks/example-data.js",
  fetchedAt: {
...
insertBenchmarkRawRows(collector, snapshots, SNAPSHOT_TABLES.mercor_apex_agents);
...
assert.equal(vendingBench2Rows[0]?.daily_balance_usd_json, "[500,700,10936.76]");
