...
| ALE-Bench | 1 | 40% | 60% | Heuristic-programming tasks require algorithm design, executable code, and evaluation-harness interaction. The mix supports both dimensions, with more weight on Agentic execution. |
